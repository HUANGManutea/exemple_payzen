...
export class OrderFormComponent {
  ...
  constructor(private formBuilder: FormBuilder, public paymentService: PaymentService, private cartService: CartService) {
    this.orderFormGroup = this.formBuilder.group({
      amount: [this.cartService.cartSource.value.total],
      currency: ["XPF"],
